        ...
        $('#lightbox').css('position', 'fixed')
                ...
                */
                ...
                if ((!getImageSetOf(imageObject) || (getImageSetOf(imageObject) == '')) && !opts.allSet) {
                        ...
                        var lightboxTop = arrayPageScroll[1] + ($(window).height() / 10) - 70;
            ...
            function getImageSetOf(imageObject) {
                ...
                $.fn.lightbox.defaults = {
                 triggerEvent: "click",
                        allSet: false,
                        fileLoadingImage: '/skin/frontend/default/clearit/css/images/loading.gif',
                        fileBottomNavCloseImage: '/skin/frontend/default/clearit/css/images/closelabel.gif',
                        overlayOpacity: 0.6,
                        borderSize: 10,
