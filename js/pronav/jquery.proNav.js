...
(function($){	
	...
	$("li.primary-pronav-item:not(.extra):last").addClass("last-pronav-item");
	...
	function checkBrowserWidth(){
		...
		if ( $("#pronav-selection-container").css("display") == "block" ) {
			...
			$("#pronav-selection-container").addClass("responsive");  
		} else {
	...
	function generateSelectDropdown(){ 
		...
		$("#pronav-select-toggle").click(function(){
                ...
                $('#primary-pronav-item').click(function(){
                     //$('ul#pronav').addClass('deactivate');
                });
                
                $('#pronav-sub-select-toggle').click(function(){
//                    $("ul#pronav").removeClass("deactivate");
//                    $(this).parent().hide();
//                    $('#pronav-panels-container > .sub').hide();
                });
	}
	...
	/********************************************************* END CHILD DROPDOWNS *********************************************************/
        ...
        $("a.mobi-nav-toggle").click(function(){
            $('body').toggleClass('mobi-nav');
        })
