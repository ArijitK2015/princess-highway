...
class Aromicon_Gua_Block_Gua extends Mage_Core_Block_Template
{
	...
	{
		$cartPath =  Mage::getStoreConfig('aromicon_gua/ecommerce/cart_url') != "" ? Mage::getStoreConfig('aromicon_gua/ecommerce/cart_url') : '/checkout/cart';
        if(Mage::getStoreConfigFlag('aromicon_gua/ecommerce/enableec')
