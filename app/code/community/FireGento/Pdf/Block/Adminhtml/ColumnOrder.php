    ...
    protected function _getSortableListHtml(Varien_Data_Form_Element_Abstract $element)
    {
        $availableItems = array(
            'price_incl_tax'    => array(
                'width' => FireGento_Pdf_Model_Engine_Invoice_Default::INVOICE_COLUMN_WIDTH_PRICE_TAX,
                'label' => $this->__('Price (+ tax)')),
            'price'             => array(
                'width' => FireGento_Pdf_Model_Engine_Invoice_Default::INVOICE_COLUMN_WIDTH_PRICE,
                'label' => $this->__('Price')),
            'qty'               => array(
                'width' => FireGento_Pdf_Model_Engine_Invoice_Default::INVOICE_COLUMN_WIDTH_QTY,
                'label' => $this->__('Qty')),
            'subtotal_incl_tax' => array(
                'width' => FireGento_Pdf_Model_Engine_Invoice_Default::INVOICE_COLUMN_WIDTH_TOTAL_TAX,
                'label' => $this->__('Subtotal (+ tax)')),
            'total'             => array(
                'width' => FireGento_Pdf_Model_Engine_Invoice_Default::INVOICE_COLUMN_WIDTH_TOTAL,
                'label' => $this->__('Total')),
            'subtotal'          => array(
                'width' => FireGento_Pdf_Model_Engine_Invoice_Default::INVOICE_COLUMN_WIDTH_SUBTOTAL,
                'label' => $this->__('Subtotal')),
            'tax'               => array(
                'width' => FireGento_Pdf_Model_Engine_Invoice_Default::INVOICE_COLUMN_WIDTH_TAX,
                'label' => $this->__('Tax amount')),
            'tax_rate'          => array(
                'width' => FireGento_Pdf_Model_Engine_Invoice_Default::INVOICE_COLUMN_WIDTH_TAX_RATE,
                'label' => $this->__('Tax rate')),
            'discount_amount'   => array(
                'width' => FireGento_Pdf_Model_Engine_Invoice_Default::INVOICE_COLUMN_WIDTH_DISCOUNT,
