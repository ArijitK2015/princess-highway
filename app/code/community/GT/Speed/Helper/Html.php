...
class GT_Speed_Helper_html extends Mage_Core_Helper_Abstract {
    ...
    public function printExpiresSetting() 
    {
        ...
        if ($expires & 1) {
            ...
            if ($expires & 2) {
                ...
                $html .= ' [ <a href="'.Mage::getModel('adminhtml/url')->getUrl('adminhtml/gtspeed/expires').'">';
    ...
    {
        $enabled = '<span style="color: green;font-weight: bold;">enabled</span> [ <a href="'.Mage::getModel('adminhtml/url')->getUrl('adminhtml/gtspeed/'.$link).'">disable</a> ] ';
        $disabled = '<span style="color: red;font-weight: bold;">disabled</span> [ <a href="'.Mage::getModel('adminhtml/url')->getUrl('adminhtml/gtspeed/'.$link).'">enable</a> ]';
