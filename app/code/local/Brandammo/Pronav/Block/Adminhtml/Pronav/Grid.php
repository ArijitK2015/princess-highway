...
class Brandammo_Pronav_Block_Adminhtml_Pronav_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
	  ...
	  $this->addColumn('link', array(
          'header'    => Mage::helper('pronav')->__('Is this a Link?'),
          'align'     => 'left',
          'width'     => '80px',
          'index'     => 'link',
          'type'      => 'options',
	  ...
	  $this->addColumn('sub_position', array(
          'header'    => Mage::helper('pronav')->__('Dropdown Alignment'),
          'align'     => 'left',
          'width'     => '80px',
          'index'     => 'sub_position',
          'type'      => 'options',
	  ...
	  $this->addColumn('sub_start', array(
          'header'    => Mage::helper('pronav')->__('Menu Alignment'),
          'align'     => 'left',
          'width'     => '80px',
          'index'     => 'sub_start',
          'type'      => 'options',
          'options'   => array(
              1 => 'Align to Relative Nav Item',
              2 => 'Align to Navigation Start',
              3 => 'Align to Navigation End'
          ),
      ));
	  
	  $this->addColumn('no_follow', array(
          'header'    => Mage::helper('pronav')->__('Add nofollow?'),
          'align'     => 'left',
          'width'     => '80px',
          'index'     => 'no_follow',
          'type'      => 'options',
	  ...
	  $this->addColumn('responsive', array(
          'header'    => Mage::helper('pronav')->__('Hide from Responsive Menus?'),
          'align'     => 'left',
          'width'     => '80px',
          'index'     => 'responsive',
          'type'      => 'options',
