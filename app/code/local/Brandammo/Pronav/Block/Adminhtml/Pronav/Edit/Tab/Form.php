...
class Brandammo_Pronav_Block_Adminhtml_Pronav_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
	  ...
	  $fieldset->addField('i_index', 'text', array(
     ...
     if (!Mage::app()->isSingleStoreMode()) {
	  ...
	  $fieldset->addField('link', 'select', array(
          'label'     => Mage::helper('pronav')->__('Is this a Link?'),
          'name'      => 'link',
          'values'    => array(
              array(
                  'value'     => 1,
                  'label'     => Mage::helper('pronav')->__('Yes'),
              ),

              array(
                  'value'     => 2,
                  'label'     => Mage::helper('pronav')->__('No'),
              ),
          ),
      ));
	  
	  $fieldset->addField('sub_position', 'select', array(
          'label'     => Mage::helper('pronav')->__('Dropdown Alignment'),
          'name'      => 'sub_position',
          'values'    => array(
              array(
                  'value'     => 1,
                  'label'     => Mage::helper('pronav')->__('Left'),
              ),

              array(
                  'value'     => 2,
                  'label'     => Mage::helper('pronav')->__('Right'),
              ),
          ),
      ));
	  
	  $fieldset->addField('sub_start', 'select', array(
          'label'     => Mage::helper('pronav')->__('Menu Alignment'),
          'name'      => 'sub_start',
          'values'    => array(
              array(
                  'value'     => 1,
                  'label'     => Mage::helper('pronav')->__('Align to Relative Nav Item'),
              ),

              array(
                  'value'     => 2,
                  'label'     => Mage::helper('pronav')->__('Align to Navigation Start'),
              ),
              array(
                  'value'     => 3,
                  'label'     => Mage::helper('pronav')->__('Align to Navigation End'),
              )
          ),
      ));
	  
	   $fieldset->addField('no_follow', 'select', array(
          'label'     => Mage::helper('pronav')->__('Add nofollow?'),
          'name'      => 'no_follow',
          'values'    => array(
              array(
                  'value'     => 1,
	  ...
	  $fieldset->addField('responsive', 'select', array(
          'label'     => Mage::helper('pronav')->__('Hide from Responsive Menus?'),
          'name'      => 'responsive',
          'values'    => array(
              array(
                  'value'     => 1,
