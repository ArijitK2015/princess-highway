...
/**
 * Class FactoryX_CategoryBanners_Model_Varien_Data_Form_Element_CategorySelect
 */
class FactoryX_CategoryBanners_Model_Varien_Data_Form_Element_CategorySelect extends Varien_Data_Form_Element_Abstract
{
    /**
    ...
    public function getElementHtml()
    {
		...
		$categories = Mage::helper('categorybanners')->getCategoriesArray();
