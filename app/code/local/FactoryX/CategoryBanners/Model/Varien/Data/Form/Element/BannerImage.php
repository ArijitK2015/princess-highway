...
/**
 * Class FactoryX_CategoryBanners_Model_Varien_Data_Form_Element_BannerImage
 */
class FactoryX_CategoryBanners_Model_Varien_Data_Form_Element_BannerImage extends Varien_Data_Form_Element_Abstract
{
    /**
     *    Constructor for custom Category Banner Image element
     * @param array $data
     */
    ...
    public function getElementHtml()
	{
        ...
        if ($this->getValue()) {
            ...
            if( !preg_match("/^http\:\/\/|https\:\/\//", $url) ) {
                $url = Mage::getBaseUrl('media') . 'categorybanners' . $url;
            }
