 ...
 */
class FactoryX_CategoryBanners_Model_Banner_Media_Config extends Mage_Catalog_Model_Product_Media_Config
{
    /**
     * Filesystem directory path of categorybanners images
    ...
    /**
     * Web-based directory path of categorybanners images
     * relatively to media folder
     *
     * @return string
     */
    ...
    /**
     * Filesystem directory path of temporary categorybanners images
     * relatively to media folder
     *
     * @return string
     */
    ...
    /**
     * Web-based directory path of temporary categorybanners images
     * relatively to media folder
     *
     * @return string
     */
    ...
    {
        return Mage::getBaseDir('media') . DS . 'categorybanners';
    }
    ...
    {
        return Mage::getBaseUrl('media') . 'categorybanners';
    }
    ...
    /**
     * Part of URL of temporary categorybanners images
     * relatively to media folder
     *
     * @param $file
     * @return string
    ...
    /**
     * Part of URL of categorybanners images relatively to media folder
     *
     * @param $file
     * @return string
     */
