 ...
 * Time: 12:58
 */
class FactoryX_AjaxLogin_IndexController extends Mage_Core_Controller_Front_Action
{
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if (!empty($login['username']) && !empty($login['password'])) {
                try {
                    ...
                    $result['success'] = true;
                    $result['message'] = Mage::helper('ajaxlogin')->__('Thank you for logging in! You will be automatically returned to the page you came from in 5 seconds. To view your account details click <a href="%s">here</a>.',Mage::getUrl('customer/account', array('_secure' => true)));
                } catch (Mage_Core_Exception $e) {
                    switch ($e->getCode()) {
