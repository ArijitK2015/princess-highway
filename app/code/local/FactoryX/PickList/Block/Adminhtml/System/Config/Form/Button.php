...
/**
 * Class FactoryX_PickList_Block_Adminhtml_System_Config_Form_Button
 */
abstract class FactoryX_PickList_Block_Adminhtml_System_Config_Form_Button extends Mage_Adminhtml_Block_System_Config_Form_Field {
    ...
    */
    ...
    protected function _construct() {
        parent::_construct();
        //$this->setTemplate('factoryx/picklist/system/config/button.phtml');
    }
