...
class FactoryX_PickList_Helper_Mysql4_Install extends Mage_Core_Helper_Abstract 
{
     ...
     * @param array $columns
     * @return FactoryX_PickList_Helper_Mysql4_Install
     */
    ...
    public function createInstallNotice($msg_title, $msg_desc, $url = null, $severity = null)
    {
        ...
        */
        ...
        if (Mage::helper('picklist/mysql4_install' )->hasProblems ()) {
            $severity = Mage_AdminNotification_Model_Inbox::SEVERITY_MINOR;
            $msg_title .= " Problems may have occured during installation.";
            $msg_desc .= " " . Mage::helper('picklist/mysql4_install' )->getProblemsString ();
            Mage::helper('picklist/mysql4_install' )->clearProblems ();
        }
