...
/**
 * Class FactoryX_Abandonedcarts_Block_Adminhtml_Logs_Grid
 */
class FactoryX_Abandonedcarts_Block_Adminhtml_Logs_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
