...
/**
 * Class FactoryX_Abandonedcarts_Block_Adminhtml_Abandonedcarts
 */
class FactoryX_Abandonedcarts_Block_Adminhtml_Abandonedcarts extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    /**
     * Constructor
     */
