...
/**
 * Class FactoryX_Abandonedcarts_Block_Adminhtml_Saleabandonedcarts_Grid
 */
class FactoryX_Abandonedcarts_Block_Adminhtml_Saleabandonedcarts_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('product_prices', array(
            'header' => Mage::helper('abandonedcarts')->__('Cart Normal Total'),
