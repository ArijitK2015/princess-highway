...
/**
 * Class FactoryX_Abandonedcarts_Block_Adminhtml_Saleabandonedcarts
 */
class FactoryX_Abandonedcarts_Block_Adminhtml_Saleabandonedcarts extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    /**
     * Constructor
     */
    public function __construct()
    {
        ...
        $this->setTemplate('factoryx/abandonedcarts/list.phtml');
    }
