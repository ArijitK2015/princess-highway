...
/**
 * Class FactoryX_Abandonedcarts_Adminhtml_AbandonedcartsController
 */
class FactoryX_Abandonedcarts_Adminhtml_AbandonedcartsController extends Mage_Adminhtml_Controller_Action
{
    /**
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('factoryx_menu/abandonedcarts');
    }

    protected function _initAction()
    {
        $this->loadLayout()
            ->_setActiveMenu('factoryx_menu/abandonedcarts');
    ...
    public function notifySaleAllAction()
    {
        ...
        $this->_redirect('*/*/sale', array('store' =>  $this->getRequest()->getParam('store', 0)));
    }
