...
/**
 * Class FactoryX_Abandonedcarts_Model_Sales_Resource_Quote
 */
class FactoryX_Abandonedcarts_Model_Sales_Resource_Quote extends Mage_Sales_Model_Resource_Quote
{
    /**
