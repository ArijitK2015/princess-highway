...
/**
 * Improve Search
 * Source: http://markustenghamn.com/improve-search-function-magento
 */
class FactoryX_ExtendedCatalog_Model_CatalogSearch_Resource_Fulltext extends Mage_CatalogSearch_Model_Resource_Fulltext
{
    /**
    ...
    public function prepareResult($object, $queryText, $query)
    {
        ...
        if (version_compare(Mage::getVersion(), "1.9.3.0", "<") && !$query->getIsProcessed()) {
