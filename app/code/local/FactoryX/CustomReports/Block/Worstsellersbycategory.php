...
/**
 * Class FactoryX_CustomReports_Block_Worstsellersbycategory
 */
class FactoryX_CustomReports_Block_Worstsellersbycategory extends FactoryX_CustomReports_Block_Customreport
{
    /**
     *
     */
