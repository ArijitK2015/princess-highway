...
/**
 * Class FactoryX_CustomReports_Block_Bestsellersbycategory
 */
class FactoryX_CustomReports_Block_Bestsellersbycategory extends FactoryX_CustomReports_Block_Customreport
{
    /**
     *
     */
