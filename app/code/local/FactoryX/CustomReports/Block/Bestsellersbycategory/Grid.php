...
/**
 * Class FactoryX_CustomReports_Block_Bestsellersbycategory_Grid
 */
class FactoryX_CustomReports_Block_Bestsellersbycategory_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
            ...
            else
            {
                ...
                if (strtolower($categoryName)=='all')
                {
                    ...
                    $catCollection = Mage::getResourceModel('catalog/category_collection')
                        ->addFieldToFilter('entity_id', array($category['parent_id']))
                        ->addAttributeToSelect(array('name'))
                        ->setPageSize(1);                
                        
                    $parentCategoryName = $catCollection->getFirstItem()->getName();
    ...
    {        
        ...
        $collection = new FactoryX_CustomReports_Model_Report();
