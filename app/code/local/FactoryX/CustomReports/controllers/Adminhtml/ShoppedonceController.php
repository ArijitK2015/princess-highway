...
/**
 * Class FactoryX_CustomReports_ShoppedonceController
 */
class FactoryX_CustomReports_Adminhtml_ShoppedonceController extends Mage_Adminhtml_Controller_Action
{
    /**
     * @return mixed
     */
