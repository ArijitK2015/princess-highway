...
/**
 * Class FactoryX_CustomReports_WorstsellersController
 */
class FactoryX_CustomReports_Adminhtml_WorstsellersController extends Mage_Adminhtml_Controller_Action
{
    /**
     * @return mixed
     */
