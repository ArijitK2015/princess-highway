...
/**
 * Class FactoryX_CustomReports_LifetimesalesController
 */
class FactoryX_CustomReports_Adminhtml_LifetimesalesController extends Mage_Adminhtml_Controller_Action
{
    /**
     * @return mixed
     */
