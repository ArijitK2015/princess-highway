...
/**
 * Class FactoryX_CustomReports_BestsellersbycategoryController
 */
class FactoryX_CustomReports_Adminhtml_BestsellersbycategoryController extends Mage_Adminhtml_Controller_Action
{
    /**
     * @return mixed
     */
