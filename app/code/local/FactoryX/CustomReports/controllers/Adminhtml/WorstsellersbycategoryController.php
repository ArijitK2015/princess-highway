...
/**
 * Class FactoryX_CustomReports_WorstsellersbycategoryController
 */
class FactoryX_CustomReports_Adminhtml_WorstsellersbycategoryController extends Mage_Adminhtml_Controller_Action
{
    /**
     * @return mixed
     */
