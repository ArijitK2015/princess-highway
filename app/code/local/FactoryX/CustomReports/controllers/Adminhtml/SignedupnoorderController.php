...
/**
 * Class FactoryX_CustomReports_SignedupnoorderController
 */
class FactoryX_CustomReports_Adminhtml_SignedupnoorderController extends Mage_Adminhtml_Controller_Action
{
    /**
     * @return mixed
     */
