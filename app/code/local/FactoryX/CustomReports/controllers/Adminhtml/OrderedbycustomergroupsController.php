...
/**
 * Class FactoryX_CustomReports_OrderedbycustomergroupsController
 */
class FactoryX_CustomReports_Adminhtml_OrderedbycustomergroupsController extends Mage_Adminhtml_Controller_Action
{
    /**
     * @return mixed
     */
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('report/products/customergroups');
    }
