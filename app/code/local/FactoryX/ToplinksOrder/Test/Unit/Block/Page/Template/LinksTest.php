...
class FactoryX_ToplinksOrder_Test_Unit_Block_Page_Template_LinksTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $block = new FactoryX_ToplinksOrder_Block_Page_Template_Links();
    ...
    private function _addLink(FactoryX_ToplinksOrder_Block_Page_Template_Links $block)
    {
        $block->addLink(
            'Test Label',
            '/test-url',
    ...
    private function _getTheFirstLinkFromTheBlock(FactoryX_ToplinksOrder_Block_Page_Template_Links $block)
    {
        $links = $block->getLinks();
        return current($links);
    }

    private function _getThePositionFromTheFirstLinkOfTheBlock(FactoryX_ToplinksOrder_Block_Page_Template_Links $block)
    {
        $links = $block->getLinks();
        return key($links);
    }
