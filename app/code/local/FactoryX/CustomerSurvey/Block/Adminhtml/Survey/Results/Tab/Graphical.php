...
/**
 * Class FactoryX_CustomerSurvey_Block_Adminhtml_Survey_Results_Tab_Graphical
 */
class FactoryX_CustomerSurvey_Block_Adminhtml_Survey_Results_Tab_Graphical extends Mage_Adminhtml_Block_Widget
{
	var $myResponses;
    ...
    {
        parent::__construct();
        $this->setTemplate('factoryx/customersurvey/graphical.phtml');
    }
