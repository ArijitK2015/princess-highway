...
/**
 * Class FactoryX_CustomerSurvey_Block_Adminhtml_Survey_Results_Tab_General
 */
class FactoryX_CustomerSurvey_Block_Adminhtml_Survey_Results_Tab_General extends Mage_Adminhtml_Block_Widget
{
    ...
    {
        parent::__construct();
        $this->setTemplate('factoryx/customersurvey/general_results.phtml');
    }
