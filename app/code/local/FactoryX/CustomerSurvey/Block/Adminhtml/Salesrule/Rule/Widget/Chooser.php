 ...
 *
 * @category   FactoryX
 * @package    FactoryX_Customersurvey
 * @author     Raphael @ Factory X <raphael@factoryx.com.au>
 */
class FactoryX_Customersurvey_Block_Adminhtml_Salesrule_Rule_Widget_Chooser extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
    ...
    public function prepareElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $sourceUrl = $this->getUrl('adminhtml/surveywidget/chooser', array('uniq_id' => $uniqId));
    ...
    {
        return $this->getUrl('adminhtml/surveywidget/chooser', array('_current' => true));
    }
}
