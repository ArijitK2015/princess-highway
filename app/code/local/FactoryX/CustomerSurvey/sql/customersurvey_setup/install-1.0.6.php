...
try {
    ...
    $installer->run("
CREATE TABLE IF NOT EXISTS {$this->getTable('customersurvey/old_survey')} (
...
CREATE TABLE IF NOT EXISTS {$this->getTable('customersurvey/old_questions')} (
...
CREATE TABLE IF NOT EXISTS {$this->getTable('customersurvey/old_results')} (
