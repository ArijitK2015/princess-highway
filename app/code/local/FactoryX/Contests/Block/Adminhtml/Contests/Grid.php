...
/**
 * Class FactoryX_Contests_Block_Adminhtml_Contests_Grid
 */
class FactoryX_Contests_Block_Adminhtml_Contests_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
	...
	{
        $collection = Mage::getModel('contests/contest')->getCollection()->addFieldToSelect(
            array(
                'contest_id',
                'title',
                'identifier',
    ...
    protected function _prepareColumns() 
	{
		...
		$this->addColumn('list_image_url', array(
            ...
            'align' => 'left',
			'width'	=>	'94px',
			'renderer'  => 'contests/adminhtml_contests_grid_renderer_listImageUrl',
			'filter'	=> false,
			'sortable'	=> false,
        ...
        $this->addColumn('action', array(
            ...
            'width' => '180',
            'is_system' => true,
            'renderer'  => 'contests/adminhtml_template_grid_renderer_action'
        ));
