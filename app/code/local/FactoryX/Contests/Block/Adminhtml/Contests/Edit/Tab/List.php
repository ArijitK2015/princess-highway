...
class FactoryX_Contests_Block_Adminhtml_Contests_Edit_Tab_List extends Mage_Adminhtml_Block_Widget_Form
{
	...
	protected function _prepareForm() 
	{
		...
		try 
		{
            ...
            $config->setData(Mage::helper('contests')->recursiveReplace(
                            '/contests_admin/', '/' . (string) Mage::app()->getConfig()->getNode('admin/routers/adminhtml/args/frontName') . '/', $config->getData()
                    )
            );
        } 
		catch (Exception $ex) 
