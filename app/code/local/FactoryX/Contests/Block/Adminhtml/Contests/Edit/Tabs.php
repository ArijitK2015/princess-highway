...
/**
 * Class FactoryX_Contests_Block_Adminhtml_Contests_Edit_Tabs
 */
class FactoryX_Contests_Block_Adminhtml_Contests_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
		...
		// Add the email tab
		$this->addTab('email_tab', array(
            'label'     => Mage::helper('contests')->__('Email Configuration'),
            'title'     => Mage::helper('contests')->__('Email Configuration'),
            'content'   => $this->getLayout()->createBlock('contests/adminhtml_contests_edit_tab_email')->toHtml(),
			'active'	=> $active == 'email_tab' ? true : false
        ));
