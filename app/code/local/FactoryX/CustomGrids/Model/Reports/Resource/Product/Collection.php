<?php
/*
 *	Add special_price, season, brand and colour to the collection
 * 	Also add sku via another method
 */
class FactoryX_CustomGrids_Model_Reports_Resource_Product_Collection extends Mage_Reports_Model_Resource_Product_Collection
{
    /**
     * Join fields
     *
