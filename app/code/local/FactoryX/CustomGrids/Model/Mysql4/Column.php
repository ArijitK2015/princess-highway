...
/**
 * Class FactoryX_CustomGrids_Model_Mysql4_Column
 */
class FactoryX_CustomGrids_Model_Mysql4_Column extends Mage_Core_Model_Resource_Db_Abstract
{

    protected function _construct()
    {
        $this->_init('customgrids/column', 'column_id');
    }
