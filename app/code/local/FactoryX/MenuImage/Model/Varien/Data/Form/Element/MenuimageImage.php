...
/**
 * Class FactoryX_MenuImage_Model_Varien_Data_Form_Element_MenuimageImage
 */
class FactoryX_MenuImage_Model_Varien_Data_Form_Element_MenuimageImage extends Varien_Data_Form_Element_Abstract
{
    /**
    ...
    public function getElementHtml()
	{
        ...
        if ($this->getValue()) {
            ...
            if( !preg_match("/^http\:\/\/|https\:\/\//", $url) ) {
                $url = Mage::getBaseUrl('media') . 'menuimage' . $url;
            }
