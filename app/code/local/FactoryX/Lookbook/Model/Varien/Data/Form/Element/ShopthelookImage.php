...
/**
 * Class FactoryX_Lookbook_Model_Varien_Data_Form_Element_ShopthelookImage
 */
class FactoryX_Lookbook_Model_Varien_Data_Form_Element_ShopthelookImage extends Varien_Data_Form_Element_Abstract
{
    /**
     *    Constructor for custom ShopthelookImage element
     * @param array $data
     */
    ...
    public function getElementHtml()
	{
        ...
        if ($this->getValue()) {
            ...
            if( !preg_match("/^http\:\/\/|https\:\/\//", $url) ) {
                $url = Mage::getBaseUrl('media') . 'lookbook' . $url;
            }
