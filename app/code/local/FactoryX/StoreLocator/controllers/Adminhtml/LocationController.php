        ...
        if ($this->getRequest()->getPost()) {
            ...
            try {
                ...
                $model = Mage::getModel('ustorelocator/location')
                    ...
                    ->setPostcode($req->getParam('postcode'))
                    ->setSuburb($req->getParam('suburb'))
                    ...
                    ->setLabelLayout($req->getParam('label_layout'))
                    ->setLabelBranded($req->getParam('label_branded'))
                    ->setLabelLeftOffset($req->getParam('label_left_offset'))
                    ->setLabelTopOffset($req->getParam('label_top_offset'))
