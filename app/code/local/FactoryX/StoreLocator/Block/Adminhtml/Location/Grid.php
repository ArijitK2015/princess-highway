 ...
 * @author
 */
class FactoryX_StoreLocator_Block_Adminhtml_Location_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('store_code', array(
                                       'header' => Mage::helper('ustorelocator')->__('Code'),
                                       'align'  => 'left',
                                       'index'  => 'store_code',
                                  ));

        $this->addColumn('store_type', array(
                                       'header' => Mage::helper('ustorelocator')->__('Type'),
                                       'align'  => 'left',
                                       'index'  => 'store_type',
                                  ));
