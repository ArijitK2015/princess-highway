...
class FactoryX_StoreLocator_Model_Import
    extends Mage_Core_Model_Config_Data
{
    ...
    /**
     * @var FactoryX_StoreLocator_Model_Mysql4_Location
     */
    ...
    protected function importObjects($io, $rawHeaders)
    {
        try {
            ...
            Mage::helper('ustorelocator')->log($e->getTraceAsString(), Zend_Log::CRIT);
        }
        return $this;
    }
    ...
    protected function importDb($io, $rawHeaders)
    {
        ...
        /* @var $hlp FactoryX_StoreLocator_Helper_Data */
    ...
    /**
     * @return FactoryX_StoreLocator_Model_Mysql4_Location
     */
     ...
     * @param FactoryX_StoreLocator_Model_Mysql4_Location $resource
     */
