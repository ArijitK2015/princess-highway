 ...
 *
 * @category   Mage
 * @package    FactoryX_TwelveHoursRange
 * @author     Raph <raphael@factoryx.com.au>
 */

class FactoryX_TwelveHoursRange_Block_Adminhtml_Dashboard_Graph extends Mage_Adminhtml_Block_Dashboard_Graph
{
    /**
     * Get chart url
     *
    ...
    {
        $availablePeriods = array_keys($this->helper('factoryx/twelvehoursrange_adminhtml_dashboard_data')->getDatePeriods());
