 ...
 *
 * Class FactoryX_ExportReview_Adminhtml_IndexController
 */
class FactoryX_ExportReview_Adminhtml_ExportreviewController extends Mage_Adminhtml_Controller_Action
{
    /**
     * @return mixed
     */
