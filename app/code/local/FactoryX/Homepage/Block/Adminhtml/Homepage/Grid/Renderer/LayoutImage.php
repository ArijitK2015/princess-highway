...
/**
 * Class FactoryX_Homepage_Block_Adminhtml_Homepage_Grid_Renderer_LayoutImage
 */
class FactoryX_Homepage_Block_Adminhtml_Homepage_Grid_Renderer_LayoutImage extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    ...
    public function render(Varien_Object $row) 
	{
		...
		else 
		{
			...
			return "<img src='" . $skinUrl . "/images/factoryx/homepage/" . $row->getLayout() . ".png' width='auto' height='75' />";
		}
    }
}
