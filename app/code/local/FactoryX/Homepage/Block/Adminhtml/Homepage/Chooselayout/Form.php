...
/**
 * Class FactoryX_Homepage_Block_Adminhtml_Homepage_Chooselayout_Form
 */
class FactoryX_Homepage_Block_Adminhtml_Homepage_Chooselayout_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
		...
		$layoutFolder = Mage::getDesign()->getSkinBaseDir(array('_theme' => 'default')).'/images/factoryx/homepage';
