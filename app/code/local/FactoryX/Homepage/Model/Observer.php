...
class FactoryX_Homepage_Model_Observer extends Mage_Core_Model_Abstract 
{
	 ...
	 * @param boolean if dryrun is set to true, it won't disable the homepage
	 */
	public function disableHomepages($dryrun = false) 
	{
		try
		{
			...
			$homepages = Mage::getResourceModel('homepage/homepage_collection')->addStatusFilter(2);
	 ...
	 * @param boolean if dryrun is set to true, it won't enable the homepage
	 */
