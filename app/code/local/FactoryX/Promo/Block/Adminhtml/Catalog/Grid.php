 ...
 */
class FactoryX_Promo_Block_Adminhtml_Catalog_Grid extends Mage_Adminhtml_Block_Promo_Catalog_Grid
{
    /**
     * Initialize grid
     * Set sort settings
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('sort_order', array(
            'header'    => Mage::helper('catalogrule')->__('Priority'),
            'align'     =>'right',
            'sortable'  => true,            
            'index'     => 'sort_order',
            'width'     => '50px'
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('delete', array(
             'label'    => Mage::helper('catalogrule')->__('Delete'),
             'url'      => $this->getUrl('*/*/massDelete'),
             'confirm'  => Mage::helper('catalogrule')->__('Are you sure?')
        ));
        return $this;
    }
