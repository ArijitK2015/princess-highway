 ...
 */
class FactoryX_ImageCdn_Model_Adapter_AmazonS3 extends FactoryX_ImageCdn_Model_Adapter_Abstract
{	
	/**
	 ...
	 *
	 * @return FactoryX_ImageCdn_Model_Adapter_AmazonS3_Wrapper
	 */
