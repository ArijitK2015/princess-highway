...
class FactoryX_ImageCdn_Model_Adapter_Sftp extends FactoryX_ImageCdn_Model_Adapter_Abstract
{	
	/**
	 * Connection handle
	 */
	...
	protected function _onConfigChange() {  
		if(!function_exists('ssh2_connect')) {
			...
			$session->addWarning('This server does not support SFTP. You must change your settings or enable the SSH2 modules on your server. See the <a href="http://us.php.net/manual/en/ssh2.installation.php" target="_blank" rel="noopener noreferrer">PHP manual</a> for more infomation.');
			return false;		
		}
