...
class CF_Authentication
{
     ...
     * </code>
     *
     * @param int|string $version API version for Auth service (optional)
...
class CF_Container
{
     ...
     * </code>
     *
     * @param string $cdn_acl_user_agent
     * @return bool True if successful
     * @throws CDNNotEnabledException
     * @throws InvalidResponseException
     */
     ...
     * @param $path_name
     * @throws InvalidResponseException
     * @throws MisMatchedChecksumException
     * @throws SyntaxException
     */
...
class CF_Object
{
     ...
     * @param float|int $bytes amount of data to upload (required for resources)
