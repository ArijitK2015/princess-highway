 ...
 */
class FactoryX_ImageCdn_Model_Adapter_Ftps extends FactoryX_ImageCdn_Model_Adapter_Ftp
{
	/**
	...
	protected function _onConfigChange() {
		if(!function_exists('ftp_ssl_connect')) {
			...
			$session->addWarning('This server does not support FTPS. You must change your settings or enable the FTP and OpenSSL modules on your server. See the <a href="http://us.php.net/manual/en/function.ftp-ssl-connect.php" target="_blank" rel="noopener noreferrer">PHP manual</a> for more infomation.');
			return false;		
		}
