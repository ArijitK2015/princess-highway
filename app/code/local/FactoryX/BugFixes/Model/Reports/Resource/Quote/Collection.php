<?php
/**
fix join on customer middle name
https://github.com/empiricompany/magento-mirror/commit/39028cc05b9eddd86ccead5fe49362b2cb89c04c
 */
class FactoryX_BugFixes_Model_Reports_Resource_Quote_Collection extends Mage_Reports_Model_Resource_Quote_Collection {
    ...
    {
        if (version_compare(Mage::getVersion(),"1.9.2","<")) {
            return parent::addCustomerData($filter);
        }
