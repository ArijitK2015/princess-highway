 ...
 *
 * @category   FactoryX
 * @package    FactoryX_ConditionalAgreement
 * @author     Raphael @ Factory X <raphael@factoryx.com.au>
 */
class FactoryX_ConditionalAgreement_Block_Adminhtml_Salesrule_Rule_Widget_Chooser extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
    ...
    {
        if ($configValue = Mage::helper('conditionalagreement')->getConditionalAgreementCondition())
        {
    ...
    public function prepareElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $sourceUrl = $this->getUrl('adminhtml/conditionalagreement/chooser', array('uniq_id' => $uniqId));
    ...
    {
        return $this->getUrl('adminhtml/conditionalagreement/chooser', array('_current' => true));
    }
}
