<?php
/** 
	Fix _addColumnFilterToCollection function to search for null 
    ...
    */
    ...
    protected function _prepareLayout()
    {
        ...
        if ($category && $category->getId()) {
	       	//Mage::log(sprintf("%s->category->getId()=%s", __METHOD__, $category->getId()) );
	        ...
	        $this->setChild('position_button',
	            $this->getLayout()->createBlock('adminhtml/widget_button')
	                ->setData(array(
	                    ...
	                    //'onclick'   => sprintf("setPosition(%s)", "categoryProducts"),
	                ))
	        );
        }
    ...
    protected function _addColumnFilterToCollection($column) {
        if ($this->getCollection()) {
            ...
            if ($column->getFilterConditionCallback()) {
                ...
                //Mage::log(sprintf("%s->Filter=%s:%s", __METHOD__, $field, print_r($cond, true)));
                if ($field && isset($cond)) {                	 
