<?php
/**
	Add the following attributes to the join:
	- price
	- special_price
	- season
	- brand
	- colour_description
	Also select the items sku
/**
 * Magento
 *
 * NOTICE OF LICENSE
    ...
    public function addOrderedQty($from = '', $to = '')
    {
        ...
        $this->getSelect()->reset()
			...
			->joinLeft(
				...
				// season = 958
				'catalog_product_entity_varchar.attribute_id=958 AND catalog_product_entity_varchar.entity_id = e.entity_id',
				array('season' => 'catalog_product_entity_varchar.value')
			)
			->joinLeft(
				'catalog_product_entity_varchar',
				// colour_description  = 942
				'catalog_product_entity_varchar.attribute_id=942 AND catalog_product_entity_varchar.entity_id = e.entity_id',
				array('colour_description' => 'catalog_product_entity_varchar.value')
			)
			*/
		...
		//Mage::log(__METHOD__ . "=" . $this->getSelect());
        return $this;
    }
