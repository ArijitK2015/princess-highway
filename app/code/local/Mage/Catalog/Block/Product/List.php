<?php
/**
	Add cache to category list block
	ab -c 5 -n 100 -X 192.168.100.3:3128 http://shop.dangerfield.com.au/girls/clothing.html
*/
...
class Mage_Catalog_Block_Product_List extends Mage_Catalog_Block_Product_Abstract {
	...
	*/
	private function makeCacheKey() {
		...
		{
			//Mage::log(sprintf("catId=%s", print_r($arr, true)));
		...
		{
			//Mage::log(sprintf("params=%s", print_r($params, true)));
			...
			$allowedKeys = array(
				...
				'dir','order','limit','q','p','mode',
				// add attributes
				'cat','brand','colour_description','dress_size','accessories_size','size_mens_28_to_36','size_shoes_girls_36_to_41','size_smlxl','top_size','id'
			);
			foreach($allowedKeys as $key) {
