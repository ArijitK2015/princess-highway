...
class Evolved_LikeAnalytics_Block_Adminhtml_Generate extends Mage_Adminhtml_Block_Widget
{
	public function __construct()
    {
        parent::__construct();
        $this->setTemplate('evlikeanalytics/generate.phtml');
        $this->setTitle(Mage::helper('evlikeanalytics')->__('Refresh Stats'));
    }
