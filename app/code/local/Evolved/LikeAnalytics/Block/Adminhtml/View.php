...
class Evolved_LikeAnalytics_Block_Adminhtml_View extends Mage_Adminhtml_Block_Widget_Grid_Container
{
	public function __construct()
	{
		$this->_controller = 'adminhtml_view';
		$this->_blockGroup = 'evlikeanalytics';
		$this->_headerText = Mage::helper('evlikeanalytics')->__('Facebook Like Stats');
		parent::__construct();
	}
