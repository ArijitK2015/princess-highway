...
class Evolved_LikeAnalytics_Model_Mysql4_Stat extends Mage_Core_Model_Mysql4_Abstract
{
	public function _construct()
	{
		$this->_init('evlikeanalytics/stat', 'stat_id');
	}
	
	public function deleteAll() {
		$query = "DELETE FROM " . Mage::getSingleton('core/resource')->getTableName('evlikeanalytics_stat') . ";";
