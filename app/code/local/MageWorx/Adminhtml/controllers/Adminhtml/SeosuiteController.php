...
class MageWorx_Adminhtml_Adminhtml_SeosuiteController extends Mage_Adminhtml_Controller_Action {
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('system/config/mageworx_seo');
    }
