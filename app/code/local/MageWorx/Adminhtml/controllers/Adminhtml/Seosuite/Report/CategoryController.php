...
class MageWorx_Adminhtml_Adminhtml_Seosuite_Report_CategoryController extends Mage_Adminhtml_Controller_Action {
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('report/seosuite/category');
    }
