...
class MageWorx_Adminhtml_Adminhtml_Seosuite_TemplateController extends Mage_Adminhtml_Controller_Action {
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('catalog/seo_templates');
    }
