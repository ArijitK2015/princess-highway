...
class MageWorx_Adminhtml_Adminhtml_Seosuite_Report_ProductController extends Mage_Adminhtml_Controller_Action {
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('report/seosuite/product');
    }
