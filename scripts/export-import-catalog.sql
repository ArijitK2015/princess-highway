...
/* Database name: df_dev (REPLACE THIS STRING WITH YOUR DANGERFIELD DATABASE NAME IN THIS FILE) */
SET @DF_WEBSITE = 3;
SET @DF_STORE = 5;
...
/* Clean Magento 1.8.1.0 Database variable */
/* Database name: magento_1_8_1_0 (REPLACE THIS STRING WITH YOUR CLEAN MAGENTO DATABASE NAME IN THIS FILE) */
...
INSERT INTO catalog_category_entity_datetime SELECT * FROM df_dev.catalog_category_entity_datetime WHERE store_id = @DF_STORE OR store_id = 0;
INSERT INTO catalog_category_entity_decimal SELECT * FROM df_dev.catalog_category_entity_decimal WHERE store_id = @DF_STORE OR store_id = 0;
INSERT INTO catalog_category_entity_int SELECT * FROM df_dev.catalog_category_entity_int	WHERE store_id = @DF_STORE OR store_id = 0;
INSERT INTO catalog_category_entity_text SELECT * FROM df_dev.catalog_category_entity_text	WHERE store_id = @DF_STORE OR store_id = 0;
INSERT INTO catalog_category_entity_varchar SELECT * FROM df_dev.catalog_category_entity_varchar	WHERE store_id = @DF_STORE OR store_id = 0;
INSERT INTO catalog_category_product SELECT * FROM df_dev.catalog_category_product;
INSERT INTO catalog_category_product_index SELECT * FROM df_dev.catalog_category_product_index	WHERE store_id = @DF_STORE OR store_id = 0;
...
INSERT INTO catalog_product_bundle_selection_price SELECT * FROM df_dev.catalog_product_bundle_selection_price	WHERE website_id = @DF_WEBSITE OR website_id = 0;
INSERT INTO catalog_product_bundle_stock_index SELECT * FROM df_dev.catalog_product_bundle_stock_index	WHERE website_id = @DF_WEBSITE OR website_id = 0;
INSERT INTO catalog_product_enabled_index SELECT * FROM df_dev.catalog_product_enabled_index	WHERE store_id = @DF_STORE OR store_id = 0;
INSERT INTO catalog_product_entity SELECT * FROM df_dev.catalog_product_entity;
INSERT INTO catalog_product_entity_datetime SELECT * FROM df_dev.catalog_product_entity_datetime	WHERE store_id = @DF_STORE OR store_id = 0;
INSERT INTO catalog_product_entity_decimal SELECT * FROM df_dev.catalog_product_entity_decimal	WHERE store_id = @DF_STORE OR store_id = 0;
INSERT INTO catalog_product_entity_gallery SELECT * FROM df_dev.catalog_product_entity_gallery	WHERE store_id = @DF_STORE OR store_id = 0;
INSERT INTO catalog_product_entity_group_price SELECT * FROM df_dev.catalog_product_entity_group_price	WHERE website_id = @DF_WEBSITE OR website_id = 0;
INSERT INTO catalog_product_entity_int	 SELECT * FROM df_dev.catalog_product_entity_int	WHERE store_id = @DF_STORE OR store_id = 0;
INSERT INTO catalog_product_entity_media_gallery SELECT * FROM df_dev.catalog_product_entity_media_gallery;
INSERT INTO catalog_product_entity_media_gallery_value SELECT * FROM df_dev.catalog_product_entity_media_gallery_value	WHERE store_id = @DF_STORE OR store_id = 0;
INSERT INTO catalog_product_entity_text SELECT * FROM df_dev.catalog_product_entity_text	WHERE store_id = @DF_STORE OR store_id = 0;
INSERT INTO catalog_product_entity_tier_price SELECT * FROM df_dev.catalog_product_entity_tier_price	WHERE website_id = @DF_WEBSITE OR website_id = 0;
INSERT INTO catalog_product_entity_varchar SELECT * FROM df_dev.catalog_product_entity_varchar	WHERE store_id = @DF_STORE OR store_id = 0;
INSERT INTO catalog_product_index_eav SELECT * FROM df_dev.catalog_product_index_eav	WHERE store_id = @DF_STORE OR store_id = 0;
INSERT INTO catalog_product_index_eav_decimal SELECT * FROM df_dev.catalog_product_index_eav_decimal	WHERE store_id = @DF_STORE OR store_id = 0;
INSERT INTO catalog_product_index_eav_decimal_idx SELECT * FROM df_dev.catalog_product_index_eav_decimal_idx	WHERE store_id = @DF_STORE OR store_id = 0;
INSERT INTO catalog_product_index_eav_decimal_tmp SELECT * FROM df_dev.catalog_product_index_eav_decimal_tmp	WHERE store_id = @DF_STORE OR store_id = 0;
INSERT INTO catalog_product_index_eav_idx SELECT * FROM df_dev.catalog_product_index_eav_idx	WHERE store_id = @DF_STORE OR store_id = 0;
INSERT INTO catalog_product_index_eav_tmp SELECT * FROM df_dev.catalog_product_index_eav_tmp	WHERE store_id = @DF_STORE OR store_id = 0;
INSERT INTO catalog_product_index_group_price SELECT * FROM df_dev.catalog_product_index_group_price	WHERE website_id = @DF_WEBSITE OR website_id = 0;
INSERT INTO catalog_product_index_price SELECT * FROM df_dev.catalog_product_index_price	WHERE website_id = @DF_WEBSITE OR website_id = 0;
INSERT INTO catalog_product_index_price_bundle_idx SELECT * FROM df_dev.catalog_product_index_price_bundle_idx	WHERE website_id = @DF_WEBSITE OR website_id = 0;
INSERT INTO catalog_product_index_price_bundle_opt_idx SELECT * FROM df_dev.catalog_product_index_price_bundle_opt_idx	WHERE website_id = @DF_WEBSITE OR website_id = 0;
INSERT INTO catalog_product_index_price_bundle_opt_tmp SELECT * FROM df_dev.catalog_product_index_price_bundle_opt_tmp	WHERE website_id = @DF_WEBSITE OR website_id = 0;
INSERT INTO catalog_product_index_price_bundle_sel_idx SELECT * FROM df_dev.catalog_product_index_price_bundle_sel_idx	WHERE website_id = @DF_WEBSITE OR website_id = 0;
INSERT INTO catalog_product_index_price_bundle_sel_tmp SELECT * FROM df_dev.catalog_product_index_price_bundle_sel_tmp	WHERE website_id = @DF_WEBSITE OR website_id = 0;
INSERT INTO catalog_product_index_price_bundle_tmp SELECT * FROM df_dev.catalog_product_index_price_bundle_tmp	WHERE website_id = @DF_WEBSITE OR website_id = 0;
INSERT INTO catalog_product_index_price_cfg_opt_agr_idx SELECT * FROM df_dev.catalog_product_index_price_cfg_opt_agr_idx	WHERE website_id = @DF_WEBSITE OR website_id = 0;
INSERT INTO catalog_product_index_price_cfg_opt_agr_tmp SELECT * FROM df_dev.catalog_product_index_price_cfg_opt_agr_tmp	WHERE website_id = @DF_WEBSITE OR website_id = 0;
INSERT INTO catalog_product_index_price_cfg_opt_idx SELECT * FROM df_dev.catalog_product_index_price_cfg_opt_idx	WHERE website_id = @DF_WEBSITE OR website_id = 0;
INSERT INTO catalog_product_index_price_cfg_opt_tmp SELECT * FROM df_dev.catalog_product_index_price_cfg_opt_tmp	WHERE website_id = @DF_WEBSITE OR website_id = 0;
INSERT INTO catalog_product_index_price_downlod_idx SELECT * FROM df_dev.catalog_product_index_price_downlod_idx	WHERE website_id = @DF_WEBSITE OR website_id = 0;
INSERT INTO catalog_product_index_price_downlod_tmp SELECT * FROM df_dev.catalog_product_index_price_downlod_tmp	WHERE website_id = @DF_WEBSITE OR website_id = 0;
INSERT INTO catalog_product_index_price_final_idx SELECT * FROM df_dev.catalog_product_index_price_final_idx	WHERE website_id = @DF_WEBSITE OR website_id = 0;
INSERT INTO catalog_product_index_price_final_tmp SELECT * FROM df_dev.catalog_product_index_price_final_tmp	WHERE website_id = @DF_WEBSITE OR website_id = 0;
INSERT INTO catalog_product_index_price_idx SELECT * FROM df_dev.catalog_product_index_price_idx	WHERE website_id = @DF_WEBSITE OR website_id = 0;
INSERT INTO catalog_product_index_price_opt_agr_idx SELECT * FROM df_dev.catalog_product_index_price_opt_agr_idx	WHERE website_id = @DF_WEBSITE OR website_id = 0;
INSERT INTO catalog_product_index_price_opt_agr_tmp SELECT * FROM df_dev.catalog_product_index_price_opt_agr_tmp	WHERE website_id = @DF_WEBSITE OR website_id = 0;
INSERT INTO catalog_product_index_price_opt_idx SELECT * FROM df_dev.catalog_product_index_price_opt_idx	WHERE website_id = @DF_WEBSITE OR website_id = 0;
INSERT INTO catalog_product_index_price_opt_tmp SELECT * FROM df_dev.catalog_product_index_price_opt_tmp WHERE website_id = @DF_WEBSITE OR website_id = 0;
INSERT INTO catalog_product_index_price_tmp SELECT * FROM df_dev.catalog_product_index_price_tmp	WHERE website_id = @DF_WEBSITE OR website_id = 0;
INSERT INTO catalog_product_index_tier_price SELECT * FROM df_dev.catalog_product_index_tier_price WHERE website_id = @DF_WEBSITE OR website_id = 0;
...
INSERT INTO catalog_product_option_price SELECT * FROM df_dev.catalog_product_option_price	WHERE store_id = @DF_STORE OR store_id = 0;
INSERT INTO catalog_product_option_title SELECT * FROM df_dev.catalog_product_option_title	WHERE store_id = @DF_STORE OR store_id = 0;
INSERT INTO catalog_product_option_type_price SELECT * FROM df_dev.catalog_product_option_type_price	WHERE store_id = @DF_STORE OR store_id = 0;
INSERT INTO catalog_product_option_type_title SELECT * FROM df_dev.catalog_product_option_type_title	WHERE store_id = @DF_STORE OR store_id = 0;
...
INSERT INTO catalog_product_super_attribute_label SELECT * FROM df_dev.catalog_product_super_attribute_label	WHERE store_id = @DF_STORE OR store_id = 0;
INSERT INTO catalog_product_super_attribute_pricing SELECT * FROM df_dev.catalog_product_super_attribute_pricing	WHERE website_id = @DF_WEBSITE OR website_id = 0;
INSERT INTO catalog_product_super_link SELECT * FROM df_dev.catalog_product_super_link;
INSERT INTO catalog_product_website SELECT * FROM df_dev.catalog_product_website	WHERE website_id = @DF_WEBSITE OR website_id = 0;
...
INSERT INTO eav_attribute_option_value SELECT * FROM df_dev.eav_attribute_option_value	WHERE store_id = @DF_STORE OR store_id = 0;
INSERT INTO eav_attribute_set SELECT * FROM df_dev.eav_attribute_set;
INSERT INTO eav_entity SELECT * FROM df_dev.eav_entity	WHERE store_id = @DF_STORE OR store_id = 0;
...
INSERT INTO eav_form_fieldset_label SELECT * FROM df_dev.eav_form_fieldset_label	WHERE store_id = @DF_STORE OR store_id = 0;
