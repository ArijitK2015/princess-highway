...
var fadeSlideShow_descpanel={
	controls: [['x.png',7,7], ['restore.png',10,11], ['/skin/frontend/default/princess/images/loader.gif',54,55]], //full URL and dimensions of close, restore, and loading images
...
fadeSlideShow.routines={
	...
	getSlideHTML:function(imgelement,dimensions){
		...
		layerHTML+='<img height="'+dimensions[1]+'" width="'+dimensions[0]+'" src="'+imgelement[0]+'" style="border-width:0;" />\n'
