...
(function() {
    ...
    var b = {version: "v2.7.4",UUID: 0,storage: {},$uuid: function(d) {
        ...
        if (f.item) {
            var e = f.length || 0, d = new Array(e);
            while (e--) {
                d[e] = f[e]
            }
            return $mjs(d)
    ...
    window.magicJS = b;
    window.$mjs = b.$;
    a.Array = {$J_TYPE: "array",indexOf: function(g, h) {
        var d = this.length;
    ...
    a.implement(String, {$J_TYPE: "string",j26: function() {
    ...
    b.implement(Function, {$J_TYPE: "function",j24: function() {
        var e = a.$A(arguments), d = this, f = e.shift();
        return function() {
    ...
    a.j21 = {features: {xpath: !!(document.evaluate),air: !!(window.runtime),query: !!(document.querySelector)},touchScreen: function() {
        return "ontouchstart" in window || (window.DocumentTouch && document instanceof DocumentTouch)
    }(),mobile: c.match(/android|tablet|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od|ad)|iris|kindle|lge |maemo|midp|mmp|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|symbian|treo|up\.(j21|link)|vodafone|wap|windows (ce|phone)|xda|xiino/) ? true : false,engine: (window.opera) ? "presto" : !!(window.ActiveXObject) ? "trident" : (undefined != document.getBoxObjectFor || null != window.mozInnerScreenY) ? "gecko" : (null != window.WebKitPoint || !navigator.taintEnabled) ? "webkit" : "unknown",version: "",ieMode: 0,platform: c.match(/ip(?:ad|od|hone)/) ? "ios" : (c.match(/(?:webos|android)/) || navigator.platform.match(/mac|win|linux/i) || ["other"])[0].toLowerCase(),backCompat: document.compatMode && "backcompat" == document.compatMode.toLowerCase(),getDoc: function() {
    ...
    (function() {
        a.j21.fullScreen = {capable: false,enabled: function() {
            return false
        },request: function() {
        },cancel: function() {
    ...
    a.Element = {j13: function(d) {
        ...
        if (a.defined(document.documentElement.getBoundingClientRect)) {
            var d = this.getBoundingClientRect(), f = $mjs(document).j10(), h = a.j21.getDoc();
            return {top: d.top + f.y - h.clientTop,left: d.left + f.x - h.clientLeft}
        }
        var g = this, e = t = 0;
        do {
            e += g.offsetLeft || 0;
        ...
        var e = this.j8();
        var d = this.j7();
        return {top: e.top,bottom: e.top + d.height,left: e.left,right: e.left + d.width}
    ...
    a.Doc = {j7: function() {
        ...
        return {width: a.j21.getDoc().clientWidth,height: a.j21.getDoc().clientHeight}
    },j10: function() {
        return {x: window.pageXOffset || a.j21.getDoc().scrollLeft,y: window.pageYOffset || a.j21.getDoc().scrollTop}
    },j12: function() {
        var d = this.j7();
        return {width: Math.max(a.j21.getDoc().scrollWidth, d.width),height: Math.max(a.j21.getDoc().scrollHeight, d.height)}
    }};
    a.extend(document, {$J_TYPE: "document"});
    a.extend(window, {$J_TYPE: "window"});
    a.extend([a.Element, a.Doc], {j29: function(g, e) {
        var d = a.getStorage(this.$J_UUID), f = d[g];
    ...
    if (!(window.HTMLElement && window.HTMLElement.prototype && window.HTMLElement.prototype.getElementsByClassName)) {
        a.extend([a.Element, a.Doc], {getElementsByClassName: function(d) {
    ...
    a.extend([a.Element, a.Doc], {byClass: function() {
    ...
    a.Event = {$J_TYPE: "event",stop: function() {
        ...
        return (!a.defined(e)) ? {x: 0,y: 0} : {x: e.pageX || e.clientX + a.j21.getDoc().scrollLeft,y: e.pageY || e.clientY + a.j21.getDoc().scrollTop}
    },getTarget: function() {
    ...
    a.extend([a.Element, a.Doc], {je1: function(g, f) {
        var i = ("domready" == g) ? false : true, e = this.j29("events", {});
        e[g] = e[g] || {};
        ...
        if (jQuery(this).hasClass('MagicZoom') && (!jQuery('body').hasClass('catalog-product-view')))
            return this;
...
(function(b) {
    ...
    var a = b.$;
    b.FX = new b.Class({options: {fps: 60,duration: 500,transition: function(c) {
        return -(Math.cos(Math.PI * c) - 1) / 2
    },onStart: b.$F,onComplete: b.$F,onBeforeRender: b.$F,onAfterRender: b.$F,forceAnimation: false,roundCss: true},styles: null,init: function(d, c) {
        this.el = a(d);
    ...
    b.FX.Transition = {linear: function(c) {
        return c
    },sineIn: function(c) {
        return -(Math.cos(Math.PI * c) - 1) / 2
    },sineOut: function(c) {
...
(function(b) {
    ...
    var a = b.$;
    b.PFX = new b.Class(b.FX, {init: function(c, d) {
        this.el_arr = c;
...
var MagicZoom = (function(c) {
    ...
    c.insertCSS = function(f, h, l) {
        var i, g, j, k = [], e = -1;
        l || (l = c.stylesId);
        i = c.$(l) || (document.head || document.body).appendChild(c.$new("style", {id: l,type: "text/css"}));
    ...
    a.z48.prototype = {init: function(e) {
        this.cb = null;
        this.z9 = null;
        ...
        this._tmpp = null;
        if ("string" == c.j1(e)) {
            this._tmpp = c.$new("div").j2("magic-temporary-img").j6({position: "absolute",top: "-10000px",width: "1px",height: "1px",overflow: "hidden"}).j32(c.body);
    ...
    a.zoom.prototype = {construct: function(h, f, g) {
        var e = {};
        this.z28 = -1;
        this.z30 = false;
        this.ddx = 0;
        ...
        this.z44 = null;
        this.z1Holder = $mjs(window).j29("magiczoom:holder") || $mjs(window).j29("magiczoom:holder", c.$new("div").j6({position: "absolute",top: -10000,width: 10,height: 10,overflow: "hidden"}).j32(c.body));
        ...
        if (h) {
            ...
            this.resizeBind = function(k) {
                var j = $mjs(this.c).j29("magiczoom:window:size"), i = $mjs(window).j7();
            ...
            if (!this.divTag) {
                this.c.j6({position: "relative",display: (c.j21.gecko181) ? "block" : "inline-block",textDecoration: "none",outline: "0",cursor: "hand",overflow: "hidden"});
                if (c.j21.ieMode) {
        ...
        if (!this.z7) {
            ...
            this.z1 = new a.z48(jQuery(this.c).attr('img-href'))
        } else {
            this.z1.update(jQuery(this.c).attr('img-href'))
        }
        if (!this.z47) {
            ...
            if ("undefined" !== typeof (h)) {
                this.z47.g = $mjs(document.createElement("div")).j6({color: h[1],fontSize: h[2] + "px",fontWeight: h[3],fontFamily: "Tahoma",position: "absolute","z-index": 10 + ("" + (this.z1.self.j5("z-index") || 0)).j17(),width: h[5],textAlign: h[4],"line-height": "2em",left: "0px"}).changeContent(a.x7(h[0])).j32(this.z47.self, ((Math.floor(Math.random() * 101) + 1) % 2) ? "top" : "bottom")
            }
        }
        ...
        if (this.options.alwaysShowZoom) {
            ...
            if (this.options.zoomFade) {
                this.z2 = new c.FX(this.z47.self, {forceAnimation: "ios" === c.j21.platform})
            }
        ...
        this.z3 = $mjs(document.createElement("DIV")).j2(this.options.loadingClass).j23(this.options.loadingOpacity / 100).j6({display: "block",overflow: "hidden",position: "absolute",visibility: "hidden","z-index": 20,"max-width": (this.z7.width - 4)});
        ...
        if (this.options.selectorsEffect != "false" && undefined !== l) {
            this.ufx = true;
            var x = $mjs(this.c.cloneNode(true)).j6({position: "absolute",top: 0,left: 0,width: ""});
            var u = c.$new("div", {id: this.c.parentNode.id,"class": this.c.parentNode.className}).j2("mz-tmp-clone").j6({width: $mjs(this.c.parentNode).j5("width"),"max-width": $mjs(this.c.parentNode).j5("max-width")});
            ...
            if ("pounce" == this.options.selectorsEffect) {
                ...
                r = this.z7.self.j8(), o = k.j8(), p = m.j8(), A = k.j7(), C = m.j7()
            }
            e = function(F) {
                var D = {}, H = {}, G = {}, I = null, E = null;
                if (false === F) {
                    h.unload();
                    $mjs(h.self).j33();
                    h = null;
                ...
                if ("pounce" == this.options.selectorsEffect) {
                    ...
                    G.width = [i, h.width];
                    h.self.j32(c.body).j6({position: "absolute","z-index": 5001,left: H.left[0],top: H.top[0],width: H.width[0],height: H.height[0]});
                    I = $mjs(this.c.firstChild.cloneNode(false)).j32(c.body).j6({position: "absolute","z-index": 5000,left: D.left[0],top: D.top[0],visibility: "visible"});
                    ...
                    I = $mjs(this.c.firstChild.cloneNode(false)).j32(this.c).j6({position: "absolute","z-index": 5000,left: "0px",top: "0px",visibility: "visible",height: "auto"});
                    $mjs(this.c.firstChild).j6({visibility: "hidden"});
                    u.j33();
                    H = {opacity: [0, 1]};
                ...
                new c.PFX([this.c, h.self, (I || this.c.firstChild)], {duration: this.options.selectorsEffectSpeed,onComplete: function() {
                    if (I) {
                        I.j33();
                        I = null
                    }
        ...
        this.z4.self.j6({width: (this.z4.width - 2 * (c.j21.backCompat ? 0 : this.z4.borderWidth)) + "px",height: (this.z4.height - 2 * (c.j21.backCompat ? 0 : this.z4.borderWidth)) + "px"});
        ...
        var f = this.getViewPort(5), e = this.z7.self.j9(), j = this.options.zoomPosition, i = this.z47, g = this.options.zoomDistance, n = i.self.j7(), l = i.initTopPos, h = i.initLeftPos, k = {left: i.initLeftPos,top: i.initTopPos};
        ...
        g = g || 0;
        var f = (c.j21.touchScreen) ? {width: window.innerWidth,height: window.innerHeight} : $mjs(window).j7(), e = $mjs(window).j10();
        return {left: e.x + g,right: e.x + f.width - g,top: e.y + g,bottom: e.y + f.height - g}
    },onresize: function(i) {
        if (!this.z7 || !this.z7.ready) {
            return
        }
        var g, f, h = {width: this.z7.width,height: this.z7.height};
        this.z7.z13();
        if (this.z47.custom) {
        ...
        var f = i.getButton(), h = (/touch/i).test(i.type), j = c.now();
        if (3 == f) {
            return true
        }
        if (h) {
            ...
            this.c.j30("magiczoom:event:lastTap", {id: i.targetTouches[0].identifier,x: i.targetTouches[0].clientX,y: i.targetTouches[0].clientY,ts: j});
        ...
        var f = i.getButton(), h = (/touch/i).test(i.type), k = c.now(), j = null, g = this.options.preservePosition;
        if (3 == f) {
            return true
        }
        if (h) {
