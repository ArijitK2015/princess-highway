...
if (!class_exists('CS_REST_BaseSerialiser', false)) {
...
if (!class_exists('CS_REST_DoNothingSerialiser', false)) {
...
if (!class_exists('CS_REST_NativeJsonSerialiser', false)) {
...
if (!class_exists('CS_REST_ServicesJsonSerialiser', false)) {
