...
if (!class_exists('CS_REST_BaseTransport', false)) {
 ...
 * @since 1.0
 */
if (!class_exists('CS_REST_CurlTransport', false)) {
...
if (!class_exists('CS_REST_SocketWrapper', false)) {
...
if (!class_exists('CS_REST_SocketTransport', false)) {
